...
fcc_status_e fcc_developer_flow(void)
{
    ...
    const fcc_deloveper_mode_item_params_s fcc_deloveper_mode_item_params_table[] = {
        ...
        { g_fcc_endpoint_parameter_name,               KCM_CONFIG_ITEM,      (const uint8_t*)MBED_CLOUD_DEV_BOOTSTRAP_ENDPOINT_NAME,   strlen((char*)MBED_CLOUD_DEV_BOOTSTRAP_ENDPOINT_NAME) },
        ...
        { g_fcc_bootstrap_server_uri_name,             KCM_CONFIG_ITEM,       (const uint8_t*)MBED_CLOUD_DEV_BOOTSTRAP_SERVER_URI,     strlen((char*)MBED_CLOUD_DEV_BOOTSTRAP_SERVER_URI) },
        //device meta data
        { g_fcc_manufacturer_parameter_name,           KCM_CONFIG_ITEM,      (const uint8_t*)MBED_CLOUD_DEV_MANUFACTURER,              strlen((char*)MBED_CLOUD_DEV_MANUFACTURER) },
        { g_fcc_model_number_parameter_name,           KCM_CONFIG_ITEM,      (const uint8_t*)MBED_CLOUD_DEV_MODEL_NUMBER,              strlen((char*)MBED_CLOUD_DEV_MODEL_NUMBER) },
        { g_fcc_device_serial_number_parameter_name,   KCM_CONFIG_ITEM,      (const uint8_t*)MBED_CLOUD_DEV_SERIAL_NUMBER,             strlen((char*)MBED_CLOUD_DEV_SERIAL_NUMBER) },
        { g_fcc_device_type_parameter_name,            KCM_CONFIG_ITEM,      (const uint8_t*)MBED_CLOUD_DEV_DEVICE_TYPE,               strlen((char*)MBED_CLOUD_DEV_DEVICE_TYPE) },
        { g_fcc_hardware_version_parameter_name,       KCM_CONFIG_ITEM,      (const uint8_t*)MBED_CLOUD_DEV_HARDWARE_VERSION,          strlen((char*)MBED_CLOUD_DEV_HARDWARE_VERSION) },
