...
void M2MBase::send_notification_delivery_status(const M2MBase& object, const NoticationDeliveryStatus status)
{
...
NoticationDeliveryStatus M2MBase::get_notification_delivery_status() const
{
