...
const char *MCC_VERSION = "mccv=1.2.6";
            ...
            if (address_copy) {
                ...
                if (query != NULL) {
                    ...
                    if (param_count) {
                        ...
                        if (uri_query_parameters(query, uri_query_params,0)) {


                            uri_query_parameters((char*)MCC_VERSION, uri_query_params, param_count);
                            param_count += query_param_count((char*)MCC_VERSION);
