...
void M2MResourceBase::notification_status(const uint16_t msg_id, const NoticationStatus status)
{
...
M2MResourceBase::NoticationStatus M2MResourceBase::notification_status() const
{
