...
public:
    ...
    enum M2MCallbackType {
        ...
        // typedef void(*notification_status_callback_2) (const uint16_t msg_id, const M2MResourceBase::NoticationStatus status);
        M2MResourceInstanceNotificationStatusCallback2,

        // typedef void(*notification_delivery_status_cb) (const M2MBase& base,
        // const M2MBase::NoticationDeliveryStatus status, void *client_args);
