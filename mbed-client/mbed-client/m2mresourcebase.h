...
public:
    ...
    typedef FP2<void, const uint16_t, const M2MResourceBase::NoticationStatus> notification_status_callback;

    typedef void(*notification_status_callback_2) (const uint16_t msg_id,
                                                 const M2MResourceBase::NoticationStatus status);
...
public:
    ...
    */
     ...
     */
    void notification_status(const uint16_t msg_id, NoticationStatus status);

    /**
     * \brief Returns notification send status.
     * \return Notification status.
     */
    M2MResourceBase::NoticationStatus notification_status() const;
...
private:
    ...
    NoticationStatus    _notification_status : 2;
