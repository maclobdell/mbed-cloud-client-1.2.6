...
public:
    ...
    */
     ...
     */
    void send_notification_delivery_status(const M2MBase& object, const NoticationDeliveryStatus status);
...
protected:
    ...
    */
     ...
     */
    NoticationDeliveryStatus get_notification_delivery_status() const;
