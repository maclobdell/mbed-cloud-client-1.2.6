...
#define PAL_CRYPTO_TEST_CERT_TIME_OFFSET 10000

static const palX509VertifyTestVector_t x509_verify_data[4] =
{
		...
		{ x509_verify_ca, sizeof(x509_verify_ca), x509_verify_cert, sizeof(x509_verify_cert), PAL_ERR_X509_BADCERT_FUTURE },
		{ x509_verify_cert, sizeof(x509_verify_cert), x509_verify_ca, sizeof(x509_verify_ca), PAL_ERR_X509_BADCERT_EXPIRED },
};
