...
typedef enum {
	...
	PAL_ERR_INVALID_ARGUMENT =      PAL_ERR_GENERAL_BASE + 1,   /*! One or more of the function arguments is invalid. */
	PAL_ERR_NO_MEMORY =             PAL_ERR_GENERAL_BASE + 2,   /*! Failure due to a failed attempt to allocate memory. */
	PAL_ERR_BUFFER_TOO_SMALL =      PAL_ERR_GENERAL_BASE + 3,   /*! The buffer given is too small. */
	PAL_ERR_NOT_SUPPORTED =         PAL_ERR_GENERAL_BASE + 4,   /*! The operation is not supported by PAL for the current configuration. */
	PAL_ERR_TIMEOUT_EXPIRED =       PAL_ERR_GENERAL_BASE + 5,   /*! The timeout for the operation has expired. */
	PAL_ERR_NOT_INITIALIZED =       PAL_ERR_GENERAL_BASE + 6,   /*! The timeout for the operation has expired. */
	PAL_ERR_NULL_POINTER     =      PAL_ERR_GENERAL_BASE + 7,   /*! Received a null pointer when it should be initialized. */
	PAL_ERR_CREATION_FAILED =       PAL_ERR_GENERAL_BASE + 8,   /*! Failure in creation of the given type, such as mutex or thread. */
	PAL_ERR_END_OF_FILE =           PAL_ERR_GENERAL_BASE + 9,   /*! The reading process finished since end of file reached. */
	PAL_ERR_INVALID_TIME =          PAL_ERR_GENERAL_BASE + 10,  /*! Invalid time value. */
	PAL_ERR_GET_DEV_KEY =           PAL_ERR_GENERAL_BASE + 11,  /*! Failure deriving the key from RoT. */
	PAL_ERR_TIME_TRANSLATE =        PAL_ERR_GENERAL_BASE + 12,  /*! Failure to translate the time from "struct tm" to epoch time. */
	PAL_ERR_SYSCALL_FAILED =		PAL_ERR_GENERAL_BASE + 13,  /*! Failure of calling a system call using system, popen, exec and ect.*/
	// pal errors
	...
	PAL_ERR_RTOS_TRNG_FAILED =                              PAL_ERR_MODULE_RTOS_BASE + 1,
	...
	PAL_ERR_NO_HIGH_RES_TIMER_LEFT =                        PAL_ERR_RTOS_ERROR_BASE + 0x88,/*! only one high resolution timer at a time is supported by pal  */
	...
	PAL_ERR_X509_BADCERT_EXPIRED =                          PAL_ERR_CRYPTO_ERROR_BASE + 21,
	PAL_ERR_X509_BADCERT_FUTURE =                           PAL_ERR_CRYPTO_ERROR_BASE + 22,
	PAL_ERR_X509_BADCERT_BAD_MD =                           PAL_ERR_CRYPTO_ERROR_BASE + 23,
	PAL_ERR_X509_BADCERT_BAD_PK =                           PAL_ERR_CRYPTO_ERROR_BASE + 24,
	PAL_ERR_X509_BADCERT_NOT_TRUSTED =                      PAL_ERR_CRYPTO_ERROR_BASE + 25,
	PAL_ERR_X509_BADCERT_BAD_KEY =                          PAL_ERR_CRYPTO_ERROR_BASE + 26,
	PAL_ERR_PARSING_PRIVATE_KEY  =                          PAL_ERR_CRYPTO_ERROR_BASE + 27,
	PAL_ERR_PARSING_PUBLIC_KEY   =                          PAL_ERR_CRYPTO_ERROR_BASE + 28,
	PAL_ERR_KEYPAIR_GEN_FAIL     =                          PAL_ERR_CRYPTO_ERROR_BASE + 29,
	PAL_ERR_X509_UNKNOWN_OID     =                          PAL_ERR_CRYPTO_ERROR_BASE + 30,
	PAL_ERR_X509_INVALID_NAME    =                          PAL_ERR_CRYPTO_ERROR_BASE + 31,
	PAL_ERR_FAILED_TO_SET_KEY_USAGE =                       PAL_ERR_CRYPTO_ERROR_BASE + 32,
	PAL_ERR_INVALID_KEY_USAGE    =                          PAL_ERR_CRYPTO_ERROR_BASE + 33,
	PAL_ERR_SET_EXTENTION_FAILED =                          PAL_ERR_CRYPTO_ERROR_BASE + 34,
	PAL_ERR_CSR_WRITE_DER_FAILED =                          PAL_ERR_CRYPTO_ERROR_BASE + 35,
	PAL_ERR_FAILED_TO_COPY_KEYPAIR =                        PAL_ERR_CRYPTO_ERROR_BASE + 36,
	PAL_ERR_FAILED_TO_COPY_GROUP =                          PAL_ERR_CRYPTO_ERROR_BASE + 37,
	PAL_ERR_FAILED_TO_WRITE_SIGNATURE =                     PAL_ERR_CRYPTO_ERROR_BASE + 38,
	PAL_ERR_FAILED_TO_VERIFY_SIGNATURE =                    PAL_ERR_CRYPTO_ERROR_BASE + 39,
	PAL_ERR_FAILED_TO_WRITE_PRIVATE_KEY =                   PAL_ERR_CRYPTO_ERROR_BASE + 40,
	PAL_ERR_FAILED_TO_WRITE_PUBLIC_KEY  =                   PAL_ERR_CRYPTO_ERROR_BASE + 41,
	PAL_ERR_FAILED_TO_COMPUTE_SHRED_KEY =                   PAL_ERR_CRYPTO_ERROR_BASE + 42,
	PAL_ERR_INVALID_X509_ATTR =                             PAL_ERR_CRYPTO_ERROR_BASE + 43,
	PAL_ERR_INVALID_CIPHER_ID =                             PAL_ERR_CRYPTO_ERROR_BASE + 44,
	PAL_ERR_CMAC_START_FAILED =                             PAL_ERR_CRYPTO_ERROR_BASE + 45,
	PAL_ERR_CMAC_UPDATE_FAILED =                            PAL_ERR_CRYPTO_ERROR_BASE + 46,
	PAL_ERR_CMAC_FINISH_FAILED =                            PAL_ERR_CRYPTO_ERROR_BASE + 47,
	PAL_ERR_INVALID_IOD =                                   PAL_ERR_CRYPTO_ERROR_BASE + 48,
	PAL_ERR_PK_UNKNOWN_PK_ALG =                             PAL_ERR_CRYPTO_ERROR_BASE + 49,
	PAL_ERR_PK_KEY_INVALID_VERSION =                        PAL_ERR_CRYPTO_ERROR_BASE + 50,
	PAL_ERR_PK_KEY_INVALID_FORMAT =                         PAL_ERR_CRYPTO_ERROR_BASE + 51,
	PAL_ERR_PK_PASSWORD_REQUIRED =                          PAL_ERR_CRYPTO_ERROR_BASE + 52,
	PAL_ERR_PK_INVALID_PUBKEY_AND_ASN1_LEN_MISMATCH =       PAL_ERR_CRYPTO_ERROR_BASE + 53,
	PAL_ERR_ECP_INVALID_KEY =                               PAL_ERR_CRYPTO_ERROR_BASE + 55,
	PAL_ERR_FAILED_SET_TIME_CB =                            PAL_ERR_CRYPTO_ERROR_BASE + 56,
	PAL_ERR_HMAC_GENERIC_FAILURE =                          PAL_ERR_CRYPTO_ERROR_BASE + 57,
	PAL_ERR_X509_CERT_VERIFY_FAILED =                       PAL_ERR_CRYPTO_ERROR_BASE + 58,
