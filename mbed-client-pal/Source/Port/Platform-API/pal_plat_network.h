...
/*! Get options for a given network socket. Only a few options are supported (see `palSocketOptionName_t`).
...
* If the timeout expires, the returned `palStatus_t` is PAL_SUCCESS and `numberOfSocketsSet` is 0. \n
